function [out, valid] = serializeBus_TrialDataBus(bus, namePrefix)
%#codegen
...
%   BusSerialize.writeSerializeBusCode('TrialDataBus')
    ...
    valid = uint8(0);
    coder.varsize('out', 1730 + 53*numel(namePrefix));
    outSize = getSerializedBusLength_TrialDataBus(bus, namePrefix);
    assert(outSize <= 1730 + 53*numel(namePrefix));
