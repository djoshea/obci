function [out, valid] = serializeBus_MouseInputBus(bus, namePrefix)
%#codegen
...
%   BusSerialize.writeSerializeBusCode('MouseInputBus')
    ...
    valid = uint8(0);
    outSize = getSerializedBusLength_MouseInputBus(bus, namePrefix);
    assert(outSize <= 160 + 6*numel(namePrefix));
