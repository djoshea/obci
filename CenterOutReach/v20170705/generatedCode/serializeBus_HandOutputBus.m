function [out, valid] = serializeBus_HandOutputBus(bus, namePrefix)
%#codegen
...
%   BusSerialize.writeSerializeBusCode('HandOutputBus')
    ...
    valid = uint8(0);
    coder.varsize('out', 459 + 15*numel(namePrefix));
    outSize = getSerializedBusLength_HandOutputBus(bus, namePrefix);
    assert(outSize <= 459 + 15*numel(namePrefix));
