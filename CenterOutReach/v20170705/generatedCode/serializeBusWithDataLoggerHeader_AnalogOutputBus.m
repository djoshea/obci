function [out, valid] = serializeBusWithDataLoggerHeader_AnalogOutputBus(bus, groupType, groupName, timestamp, namePrefix)
%#codegen
% DO NOT EDIT: Auto-generated by 
%   BusSerialize.writeSerializeBusCode('AnalogOutputBus')
    ...
    outSize = headerLength + getSerializedBusLength_AnalogOutputBus(bus, namePrefix);
    assert(outSize <= headerLength + 53 + 2*numel(namePrefix));
    out = zeros(outSize, 1, 'uint8');
    offset = uint32(1);

    % Serialize data logger header
    header = BusSerialize.serializeDataLoggerHeader(groupType, uint8([namePrefixBytes, groupName]), uint32(974610851), uint16(2), timestamp);
