function [out, valid] = serializeBus_ConditionFixedBus(bus, namePrefix)
%#codegen
...
%   BusSerialize.writeSerializeBusCode('ConditionFixedBus')
    ...
    valid = uint8(0);
    coder.varsize('out', 747 + 23*numel(namePrefix));
    outSize = getSerializedBusLength_ConditionFixedBus(bus, namePrefix);
    assert(outSize <= 747 + 23*numel(namePrefix));
