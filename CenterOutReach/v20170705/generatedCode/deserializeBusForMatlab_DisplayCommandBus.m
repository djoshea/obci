function [bus, valid, offset] = deserializeBusForMatlab_DisplayCommandBus(input, offset, valid, namePrefix)
%#codegen
        ...
        if valid && elements == uint32(0)
            ...
            if elements > uint32(0)
                ...
                if nValues <= 1 && valueValid
                    ...
                    bus.taskCommand = typecast(in(offset:offset+uint32(elements*1 - 1)), 'char');
                end
