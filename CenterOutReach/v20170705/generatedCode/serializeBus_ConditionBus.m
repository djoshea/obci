function [out, valid] = serializeBus_ConditionBus(bus, namePrefix)
%#codegen
...
%   BusSerialize.writeSerializeBusCode('ConditionBus')
    ...
    valid = uint8(0);
    coder.varsize('out', 824 + 24*numel(namePrefix));
    outSize = getSerializedBusLength_ConditionBus(bus, namePrefix);
    assert(outSize <= 824 + 24*numel(namePrefix));
