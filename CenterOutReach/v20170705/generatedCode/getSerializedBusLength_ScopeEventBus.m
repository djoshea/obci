function outSize = getSerializedBusLength_ScopeEventBus(bus, namePrefix)
%#codegen
% DO NOT EDIT: Auto-generated by 
%   BusSerialize.writeGetSerializedBusLengthCode('ScopeEventBus')
    ...
    for iEl = 1:numel(bus.event)
        outSize = outSize + uint32(numel(enumToString_ScopeEvent(bus.event(iEl)))); % for event enum to string
    end
