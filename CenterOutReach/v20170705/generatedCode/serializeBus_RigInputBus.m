function [out, valid] = serializeBus_RigInputBus(bus, namePrefix)
%#codegen
...
%   BusSerialize.writeSerializeBusCode('RigInputBus')
    ...
    valid = uint8(0);
    outSize = getSerializedBusLength_RigInputBus(bus, namePrefix);
    assert(outSize <= 4337 + 85*numel(namePrefix));
