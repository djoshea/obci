function [out, valid] = serializeBus_AnalogOutputBus(bus, namePrefix)
%#codegen
...
%   BusSerialize.writeSerializeBusCode('AnalogOutputBus')
    ...
    valid = uint8(0);
    outSize = getSerializedBusLength_AnalogOutputBus(bus, namePrefix);
    assert(outSize <= 53 + 2*numel(namePrefix));
