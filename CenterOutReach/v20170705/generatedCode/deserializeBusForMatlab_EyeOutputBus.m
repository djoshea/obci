function [bus, valid, offset] = deserializeBusForMatlab_EyeOutputBus(input, offset, valid, namePrefix)
%#codegen
% DO NOT EDIT: Auto-generated by 
%   BusSerialize.writeDeserializeBusCode('EyeOutputBus')
    ...
    bus = initializeBus_EyeOutputBus();
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
