function [out, valid] = serializeBus_TrialDataOutputBus(bus, namePrefix)
%#codegen
...
%   BusSerialize.writeSerializeBusCode('TrialDataOutputBus')
    ...
    valid = uint8(0);
    coder.varsize('out', 419 + 15*numel(namePrefix));
    outSize = getSerializedBusLength_TrialDataOutputBus(bus, namePrefix);
    assert(outSize <= 419 + 15*numel(namePrefix));
