function [bus, valid, offset] = deserializeBusForMatlab_HandOutputBus(input, offset, valid, namePrefix)
%#codegen
% DO NOT EDIT: Auto-generated by 
%   BusSerialize.writeDeserializeBusCode('HandOutputBus')
    ...
    bus = initializeBus_HandOutputBus();
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    expectedHeader_handAccelerationX = uint8([2, 5, typecast(uint16(numel(namePrefix) + 17), 'uint8'), namePrefix, 'handAccelerationX', typecast(uint16(6), 'uint8'), 'mm/sec', 0, 1])';
    ...
    expectedHeader_handAccelerationY = uint8([2, 5, typecast(uint16(numel(namePrefix) + 17), 'uint8'), namePrefix, 'handAccelerationY', typecast(uint16(6), 'uint8'), 'mm/sec', 0, 1])';
    for headerOffset = 1:uint32(31+numel(namePrefix)-1)
    ...
    expectedHeader_handAccelerationZ = uint8([2, 5, typecast(uint16(numel(namePrefix) + 17), 'uint8'), namePrefix, 'handAccelerationZ', typecast(uint16(6), 'uint8'), 'mm/sec', 0, 1])';
    for headerOffset = 1:uint32(31+numel(namePrefix)-1)
