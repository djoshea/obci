function [out, valid] = serializeBus_EyeInputBus(bus, namePrefix)
%#codegen
...
%   BusSerialize.writeSerializeBusCode('EyeInputBus')
    ...
    valid = uint8(0);
    outSize = getSerializedBusLength_EyeInputBus(bus, namePrefix);
    assert(outSize <= 74 + 3*numel(namePrefix));
