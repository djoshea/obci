function [out, valid] = serializeBusWithDataLoggerHeader_HandOutputBus(bus, groupType, groupName, timestamp, namePrefix)
%#codegen
% DO NOT EDIT: Auto-generated by 
%   BusSerialize.writeSerializeBusCode('HandOutputBus')
    ...
    coder.varsize('out', 459 + 15*numel(namePrefix) + headerLength);
    outSize = headerLength + getSerializedBusLength_HandOutputBus(bus, namePrefix);
    assert(outSize <= headerLength + 459 + 15*numel(namePrefix));
    out = zeros(outSize, 1, 'uint8');
    offset = uint32(1);

    % Serialize data logger header
    header = BusSerialize.serializeDataLoggerHeader(groupType, uint8([namePrefixBytes, groupName]), uint32(2887211990), uint16(15), timestamp);
